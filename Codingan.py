...
if(selected == "Perhitungan Impedansi Karakteristik") :
    ...
    if hitung : 
        ...
        a = (((r+(l))+(g+(c)))**0.05)
        st.write("Impedansi Karakteristik ZO (ohm) ", Z_Propagasi)
        st.write("Magnitude Impedansi Karakteristik (ohm)", a)
...
if(selected == "Perhitungan Konstanta Propagasi") :
    ...
    if hitung : 
        ...
        st.success(f"nilai konstanta propagasi nya adalah = {K_Propagasi}")
